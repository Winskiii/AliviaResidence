          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                aria-label="Instagram Alivia Residence"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                className="w-9 h-9 bg-white/10 hover:bg-primary rounded-lg flex items-center justify-center transition-colors"
                aria-label="Facebook Alivia Residence"
              >
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                { label: "Tipe Unit", action: () => scrollToSection("#unit-types") },
                { label: "Fasilitas", action: () => scrollToSection("#fasilitas") },
                { label: "Galeri", link: "/galeri" },
                { label: "Lokasi", action: () => scrollToSection("#lokasi") },
                ...
                <li key={item.label}>
                  {item.link ? (
                    <Link
                      to={item.link}
                      className="text-gray-400 hover:text-accent text-sm flex items-center gap-1.5 transition-colors group"
                    >
                    ...
                    <button
                      onClick={item.action}
                      className="text-gray-400 hover:text-accent text-sm flex items-center gap-1.5 transition-colors group text-left"
                    >
                      <ArrowRight className="w-3 h-3 opacity-0 group-hover:opacity-100 transition-opacity" />
                      {item.label}
                    </button>
            ...
            <ul className="space-y-2.5">
              {units.map((unit) => (
                <li key={unit.id}>
                  <Link
                    to={`/unit/${unit.id}`}
                    className="text-gray-400 hover:text-accent text-sm flex items-center justify-between transition-colors group"
                  >
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-400 text-sm leading-relaxed">{siteConfig.location}</span>
              </li>
              <li>
                <a
                  href={waLink}
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-6 flex items-center gap-2 bg-[#25D366] hover:bg-[#1da851] text-white px-4 py-2.5 rounded-xl text-sm font-semibold transition-all hover:shadow-lg"
            >
